...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-users"></i> Equipes</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Equipes Cadastrados</h3>
                                @can('Criar Equipes')
                                    <a href="{{ route('admin.teams.create') }}" title="Nova Equipe" class="btn btn-success"><i
                                            class="fas fa-fw fa-plus"></i>Nova Equipe</a>
                                @endcan
                            </div>
                        </div>

                        @php
                            $heads = [['label' => 'ID', 'width' => 10], 'Nome', 'Capacidade', 'Descrição', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/teams'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'capacity', 'name' => 'capacity'], ['data' => 'description', 'name' => 'description'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
