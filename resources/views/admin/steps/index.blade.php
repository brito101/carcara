...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-shoe-prints"></i> Fases</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Fases Cadastradas</h3>
                                @can('Criar Usuários')
                                    <a href="{{ route('admin.steps.create') }}" title="Nova Fase" class="btn btn-success"><i
                                            class="fas fa-fw fa-plus"></i>Nova Fase</a>
                                @endcan
                            </div>
                        </div>
