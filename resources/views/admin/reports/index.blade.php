...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-file"></i> Relatórios</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Relatórios Cadastrados</h3>
                                @can('Criar Relatórios')
                                    <a href="{{ route('admin.reports.create') }}" title="Nova Ferramenta"
                        ...
                        @php
                            $heads = [['label' => 'ID', 'width' => 5], 'Nome', 'Sistema', 'Plataforma', 'Status', 'Autor', 'Palavras chaves', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'order' => [0, 'desc'],
                                'ajax' => url('/admin/reports'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'system', 'name' => 'system'], ['data' => 'platform', 'name' => 'platform'], ['data' => 'status', 'name' => 'status'], ['data' => 'author', 'name' => 'author'], ['data' => 'keys', 'name' => 'keys'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
